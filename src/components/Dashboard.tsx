    ...
    <div className="flex flex-col mt-4">
      ...
      <div className="flex">
        ...
        <div className="flex-1 ml-4">
          ...
          {tab === "liked" && (
            <SongQueue songs={liked} onUpvote={handleUpvote} onDownvote={handleDownvote} />
          )}
          {tab === "uploads" && (
            <SongQueue songs={uploads} onUpvote={handleUpvote} onDownvote={handleDownvote} />
          )}
          {tab === "recent" && (
            <SongQueue songs={recent} onUpvote={handleUpvote} onDownvote={handleDownvote} />
          )}
