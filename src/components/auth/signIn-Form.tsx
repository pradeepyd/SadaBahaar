    ...
    <CardWrapper
        ...
        >
          ...
          <div className="space-y-3">
            ...
            />
            {errors.identifier && <p className="text-red-400 text-sm mt-1">{errors.identifier.message}</p>}
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Button
                className="p-0 h-auto text-xs font-normal text-blue-400 hover:text-blue-300 underline-offset-4"
              >
                Forgot password?
              </Button>
            </div>
